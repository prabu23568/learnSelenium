...
public class Amzone {
	public static void main(String[] args) throws IOException{
		...
		oneplus.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		
		oneplus.findElement(By.id("twotabsearchtextbox")).sendKeys("oneplus 9 pro");  //find
		...
		System.out.println(f);
		  ...
		  File source=oneplus.getScreenshotAs(OutputType.FILE);    //screenShot
